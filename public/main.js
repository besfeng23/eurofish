  ...
  section.innerHTML = `
    <div class="container">
      ...
      <div class="proof-asset-grid">
        <article class="proof-photo proof-photo-fry">
          <div class="proof-photo-media" role="img" aria-label="Milkfish fry bags or basins proof slot"></div>
          <span>Needed photo</span>
          <h3>Milkfish fry bags / basins</h3>
          <p>Use a real handling or receiving photo to prove the aquaculture side is operational.</p>
        </article>
        <article class="proof-photo proof-photo-flowers">
          <div class="proof-photo-media" role="img" aria-label="Imported flower inventory proof slot"></div>
          <span>Needed photo</span>
          <h3>Flower inventory / packing</h3>
          <p>Show actual flower stock, crates, labels, or preparation instead of generic floral visuals.</p>
        </article>
        <article class="proof-photo proof-photo-coldchain">
          <div class="proof-photo-media" role="img" aria-label="Packing and cold-chain proof slot"></div>
          <span>Needed photo</span>
          <h3>Packing / cold-chain handling</h3>
          <p>Show the practical preparation step buyers care about before receiving perishable goods.</p>
        </article>
        <article class="proof-photo proof-photo-principal">
          <div class="proof-photo-media" role="img" aria-label="Principal or team proof slot"></div>
          <span>Needed photo</span>
          <h3>Principal / team photo</h3>
          <p>A real face increases trust more than another abstract graphic.</p>
        </article>
        <article class="proof-photo proof-photo-office">
          <div class="proof-photo-media" role="img" aria-label="Office coordination proof slot"></div>
          <span>Needed photo</span>
          <h3>Office / coordination desk</h3>
          <p>Show where inquiries, supplier coordination, documents, and buyer calls are handled.</p>
        </article>
        <article class="proof-document-card">
          <span>Redacted preview</span>
          <h3>Document proof pack</h3>
          <div class="doc-preview">
            <i></i><i></i><i></i><b></b><em></em>
          </div>
          <p>Use blurred or redacted previews for business profile, BFAR/BPI-related proof when applicable, quotation template, and buyer checklist.</p>
        </article>
      </div>
    </div>
  `;
